...
Clone this repository and copy/paste the `srcpkgs` directory in your locally cloned `void-packages` repo (repository). Or, check the releases page in this repo for the latest repackaged version.
